        ...
        <>
            ...
            <div className="introduction flex justify-between max-w-screen-xl mx-auto mt-20">
                <div className="introduction-desc flex flex-col justify-center text-center sm:text-start w-full">
                    ...
                    <p className="mt-5 text-lg">Website jual barang bekas yang masih memiliki nilai ekonomis</p>
                </div>
                <div className="introduction-image md:flex md:justify-center sm:flex sm:justify-center w-full">
                    <img src={Image1} className="max-h-auto max-w-full" alt="Landing Page 1" />
                </div>
            </div>
            <div className="about-us flex justify-around max-w-screen-xl mx-auto py-20" id="about-us">
                ...
                <div className="about-text flex flex-col justify-center w-full md:mt-5">
                    ...
                    <p className="mt-3 text-lg">Sarange (akronim dari Sampah Daur Ulang (bernilai) Ekonomis) merupakan sebuah inovasi dalam upaya optimalisasi jual beli sampah. Website ini diperuntukkan untuk para perempuan Indonesia yang ingin menjual sampah daur ulang.</p>
                </div>
            </div>
            ...
            <div className="gabung mt-20 flex justify-around items-center mx-auto">
                ...
                <div className="gabung-desc w-full">
                    <h1 className="font-semibold text-4xl">Mulai Jual Sampah Daur Ulangmu di Sarange</h1>
                    <p className="my-5">Gabung dengan Sarange dan rasakan kemudahan menjual sampah</p>

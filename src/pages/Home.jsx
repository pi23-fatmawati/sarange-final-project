        ...
        <>
            ...
            <div className="home container mx-auto flex items-center justify center">
                ...
                <div className="text-home container mx-auto absolute text-center justify-center items-center w-full right-0 left-0 mt-5">
                    ...
                    <p className="text-xl font-medium">CO<sub>2</sub> berkurang karenamu </p>
                    <button className="btn-home text-white mt-2 py-2 px-10 rounded-full">Jual Sekarang</button>
                </div>
            </div>
            <div className="coin container mt-5 mx-auto w-full flex justify-around p-2">
                <Link to={'/history-coin'}  className="coin-user flex items-center gap-2 mx-auto">
                ...
                <Link to={'/redeem'} className="redeem-coin flex items-center gap-2 mx-auto">
  ...
  <div className='flex justify-center items-center'>
    <div className='w-full'>
      <div className='overflow-hidden w-full relative'>
        <div className='flex carousel-img transition-transform ease-out duration-500' style={{ transform: `translateX(-${curr * 100}%)`, width: '100%' }}>
          {slides.map((s, index) => (
            <img className="block w-full object-cover mx-0"

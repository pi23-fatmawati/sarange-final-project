        ...
        <nav style={{backgroundColor: '#D3F8B7'}} className='fixed m-0 p-0 w-full top-0'>
            <div className="navbar-content max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                    <Button className="focus:ring-4 focus:outline-none font-medium text-sm px-4 py-2 text-center" text= 'Login Sarange'></Button>
                    <button data-collapse-toggle="navbar-sticky" type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200" aria-controls="navbar-sticky" aria-expanded={isNavbarOpen} onClick={toggleNavbar}>
                ...
                <div className={`items-center justify-between ml-auto mr-10 w-full md:flex md:w-auto md:order-1 ${isNavbarOpen ? 'block' : 'hidden'}`} id="navbar-sticky">
                    <ul className='flex flex-col p-4 md:p-0 mt-4 font-medium md:space-x-8 md:flex-row md:mt-0'>
                        <li>
                            ...
                            style={{color: clickedLink === 'Beranda' ? '#254416' : '#52C41A',}} 
                            aria-current="page">Beranda</HashLink></li>
                        <li>
                        ...
                        <li><Link to={'/Edukasi'} 
                            ...
                            aria-current="page">Edukasi</Link></li>
                    </ul>
                </div>
            </div> 
        </nav>

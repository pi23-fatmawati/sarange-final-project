                ...
                <div className={`items-center justify-between ml-auto mr-10 w-full md:flex md:w-auto md:order-1 ${isNavbarOpen ? 'block' : 'hidden'}`} id="navbar-sticky">
                    <ul className='flex flex-col p-4 md:p-0 mt-4 font-medium md:space-x-8 md:flex-row md:mt-0'>
                        <li>
                            ...
                            aria-current="page">Beranda</Link></li>
                        <li>
                            <Link to="/products"
                            className='nav-link block py-2 px-3 rounded md:p-0'
                            onClick={()=> handleClickedLink('Products')}
                            style={{color: clickedLink === 'Products' ? '#254416' : '#52C41A',}} 
                            aria-current="page">Jual Sampah</Link></li>
                        <li><Link to={'/transaction'} 
                            className='nav-link block py-2 px-3 rounded md:p-0'
                            onClick={()=> handleClickedLink('Riwayat')}
                            style={{color: clickedLink === 'Riwayat' ? '#254416' : '#52C41A',}} 
                            aria-current="page">Riwayat</Link></li>
                        <li><Link to={'/Edukasi'} 
                            className='nav-link block py-2 px-3 rounded md:p-0'
